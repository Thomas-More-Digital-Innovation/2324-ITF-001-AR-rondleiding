...
**[vuforia](https://developer.vuforia.com/home)** - - API - - > **[Unity](https://unity.com/products?c=unity+engine&s=education)** - - [flutter-embed-unity](https://github.com/learntoflutter/flutter_embed_unity/releases) - - > **[Flutter](https://flutter.dev/development)**

Voor de rondleiding echt tot leven te laten komen gaan we gebruik maken van **[vuforia](https://developer.vuforia.com/home)** om 'plane detectie', 'Point-of-Interest detectie' en het renderen van de guide te doen. Vuforia kan niet rechtstreeks connecteren met een Flutter project, daarom maken we gebruik van Unity als bindmiddel. Vuforia kan connecteren met een **[Unity](https://unity.com/products?c=unity+engine&s=education)** Scene aan de hand van een API. In deze scene zal er dan een gids verschijnen. Deze scene kan dan op zijn beurt wel getoond worden door gebruik te maken van de package **[flutter-embed-unity](https://github.com/learntoflutter/flutter_embed_unity/releases)**. Dit is een package die de scene kan laten zien in een flutter applicatie.
